    ...
    <div className="w-full">
      ...
      {isExpanded && (
        <div className="mt-2 p-4 bg-red-50 rounded-lg border border-red-300 text-sm text-gray-700">
          ...
          <p className="mt-2">
            いろいろ試してもダメな場合は、お手数ですが、<a href="mailto:shunsukehirata777@gmail.com" className="text-indigo-600 underline hover:text-indigo-800">shunsukehirata777@gmail.com</a>までメールをくださいますでしょうか。
